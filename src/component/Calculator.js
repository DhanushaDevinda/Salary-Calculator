...
import { Checkbox, Divider, Form, Grid } from "semantic-ui-react";
          ...
          <Grid.Column className="left-container">
            <div className="container-space">
              <Form>
                ...
                <div className="Body-Large-Semibold mb-8 ">Basic Salary</div>
                <input
                  value={basicSalary}
                  ...
                  <Grid columns={3} key={`Grid ${idx}`}>
                    ...
                    >
                      ...
                      >
                        <img
                          src={CloseBtn}
                          onClick={() => deleteEarnings(idx)}
                          width="32px"
                          height="32px"
                          alt="add-icon"
                          className="close-btn-margin "
                        />
          ...
          <Grid.Column className="right-container">
            <div className="container-space">
              ...
              <div className="flex-space-between mb-16">
                <div className="Body-Default-Semibold ">Item</div>

                <div className="Body-Default-Semibold ">Amount</div>
              </div>
